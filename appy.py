...
# Injeta a chamada do manifesto e service worker (essenciais para ativação do PWA no celular)
pwa_setup = """
...
with st.sidebar:
    ...
    if st.session_state['logged_user'] and st.session_state['users'][st.session_state['logged_user']].get('is_admin'):
        ...
        with st.expander("🕒 Horários e Intervalos"):
            ...
            # CORREÇÃO DO ERRO: Sintaxe corrigida removendo a vírgula duplicada externa
